            ...
            >
                ...
                <View style={styles.wrapperRateAndOrder}>
                    <View style={styles.wrapperRating}>
                        <Rating readonly startingValue={5} imageSize={10} type='custom' ratingColor='#e10100' />
                        <Text style={styles.txtOrderCount} numberOfLines={1}>(12)</Text>
                    </View>
                    <View style={styles.wrapperOrderCount}>
                        <FontAwesome size={10} color='#747d8c' name={"tag"} />
                        <Text style={styles.txtOrderCount} numberOfLines={1}>35</Text>
                    </View>
                </View>
                ...
                <View style={styles.wrapperShopInfoAndShip}>
                    <View style={styles.wrapperShopInfo}>
                        ...
                        <Text style={styles.txtShopName} numberOfLines={1}>Haha</Text>
                    </View>
